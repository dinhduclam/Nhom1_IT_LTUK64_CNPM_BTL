...
public class UpdateKhaiBaoView {
...
//		initialize();
	...
	public void setData(KhaiBaoInfo khaiBao) {
		hoTen.setText(khaiBao.getHoTen());
		id.setText(khaiBao.getId());
		if (khaiBao.getTiepXucVoiNguoiBenh().equals("Có")) coTiepXucVoiNguoiBenh.setSelected(true);
		else khongTiepXucVoiNguoiBenh.setSelected(true);
		if (khaiBao.getDiVeTuVungDich().equals("Có")) coDiVeTuVungDich.setSelected(true);
		else khongDiVeTuVungDich.setSelected(true);
		if (khaiBao.getTiepXucVoiNguoiTuVungDich().equals("Có")) coTiepXucVoiNguoiTuVungDich.setSelected(true);
		else khongTiepXucVoiNguoiTuVungDich.setSelected(true);
		ngayKhaiBao.setText(khaiBao.getNgayKhaiBao().toString());
		hoTen.requestFocus();
	}
